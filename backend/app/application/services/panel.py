...
class DeliberationPanel:
    """Deliberation Panel service for multi-model contradiction adjudication."""
    ...
    async def deliberate(
        ...
        *,
        ...
        """Adjudicate logical relationship between two claims with multi-model panel."""
        return await deliberate(claim_a, claim_b, call_llm=call_llm)
